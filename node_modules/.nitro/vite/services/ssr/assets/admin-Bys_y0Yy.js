...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-txUMSKgw.js";
import { t as requireSupabaseAuth } from "./auth-middleware-0syUcLjX.js";
		...
		children: [/* @__PURE__ */ jsxs("aside", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "size-3.5" }), " Admin scope"]
								}),
								/* @__PURE__ */ jsx("div", {
						...
						/* @__PURE__ */ jsx("nav", {
							...
							children: [
								...
								children: [/* @__PURE__ */ jsx(Icon, { className: "size-[17px]" }), label]
							}, value))
						}),
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs(Link, {
								...
								children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "size-[17px]" }), " Personal workspace"]
							})
						})
					]
				}),
			...
			children: [/* @__PURE__ */ jsxs("header", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "size-3.5" }), " Role verified"]
				})]
			}), /* @__PURE__ */ jsxs("main", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [
							...
							children: [/* @__PURE__ */ jsx(Activity, { className: "size-4 text-signal" }), " Live access scope"]
						})]
					}),
					adminQuery.isPending && /* @__PURE__ */ jsx(LoadingState, {}),
					adminQuery.isError && /* @__PURE__ */ jsx(ErrorState, { message: adminQuery.error instanceof Error ? adminQuery.error.message : "This admin view could not load." }),
					adminQuery.data && /* @__PURE__ */ jsx(AdminContent, {
...
function LoadingState() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "h-32 animate-pulse rounded-xl border border-line bg-panel" }),
			/* @__PURE__ */ jsx("div", { className: "h-32 animate-pulse rounded-xl border border-line bg-panel" }),
			/* @__PURE__ */ jsx("div", { className: "h-32 animate-pulse rounded-xl border border-line bg-panel" }),
			/* @__PURE__ */ jsx("div", { className: "h-32 animate-pulse rounded-xl border border-line bg-panel" }),
			/* @__PURE__ */ jsx("div", { className: "h-96 animate-pulse rounded-xl border border-line bg-panel sm:col-span-2 xl:col-span-4" })
		]
	});
}
function ErrorState({ message }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "size-5" }), /* @__PURE__ */ jsx("span", {
...
function AdminContent({ data, tab }) {
	if (tab === "users") return /* @__PURE__ */ jsx(UsersPanel, { users: data.users });
	if (tab === "transactions") return /* @__PURE__ */ jsx(TransactionsPanel, { data });
	return /* @__PURE__ */ jsx(OverviewPanel, { data });
}
function OverviewPanel({ data }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsx("div", {
			className: "grid gap-4 sm:grid-cols-2 xl:grid-cols-4",
			children: kpis.map(([label, value, note, Icon, color]) => /* @__PURE__ */ jsxs("div", {
				className: "rounded-xl border border-line bg-panel p-5",
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "flex items-center justify-between text-[10px] font-mono uppercase tracking-[0.14em] text-mute",
						children: [/* @__PURE__ */ jsx("span", { children: label }), /* @__PURE__ */ jsx(Icon, { className: `size-4 ${color}` })]
					}),
					/* @__PURE__ */ jsx("div", {
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx(SectionHeader, {
					...
					].map(([label, value, Icon]) => /* @__PURE__ */ jsxs("div", {
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx(SectionHeader, {
					...
					children: data.categories.slice(0, 6).map((item, index) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
						className: "mb-1.5 flex justify-between text-xs",
						children: [/* @__PURE__ */ jsx("span", { children: item.name }), /* @__PURE__ */ jsx("span", {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs("table", {
				...
				}), /* @__PURE__ */ jsx("tbody", { children: users.map((user) => /* @__PURE__ */ jsxs("tr", {
			...
			}), users.length === 0 && /* @__PURE__ */ jsx(EmptyState, { copy: "No users are available yet." })]
		})]
	});
}
		...
		children: [/* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: data.statuses.map((status) => /* @__PURE__ */ jsxs("div", {
						className: "rounded-lg border border-line bg-raise p-4",
						children: [
							/* @__PURE__ */ jsx("div", {
