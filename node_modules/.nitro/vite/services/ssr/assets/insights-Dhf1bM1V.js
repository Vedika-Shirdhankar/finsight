...
import { t as useAccounts } from "./use-accounts-BXpHOKmP.js";
import { t as useCategories } from "./use-categories-BSfFvBVL.js";
import { n as useBudget } from "./use-budgets-B4foJmW9.js";
import { r as useTransactions } from "./use-transactions-Bc0pgBXv.js";
import { n as forecastNextMonthSpend, t as detectAnomalies } from "./analytics-BcG96liB.js";
import { t as Button } from "./button-PwNqyxv_.js";
import { useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { AlertTriangle, CheckCircle2, FileDown, Lightbulb, Radar, Sparkles, TrendingDown, TrendingUp } from "lucide-react";
import { Bar, CartesianGrid, Cell, ComposedChart, Line, Pie, PieChart as PieChart$1, ResponsiveContainer, Tooltip, XAxis, YAxis } from "recharts";
import jsPDF from "jspdf";
//#region src/lib/pdf-summary.ts
...
//#endregion
//#region src/routes/dashboard/insights.tsx?tsr-split=component
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				...
				children: [/* @__PURE__ */ jsxs(Button, {
					...
					children: [/* @__PURE__ */ jsx(FileDown, { className: "mr-1.5 size-3.5" }), " Monthly summary (PDF)"]
				}), /* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(TrendingUp, { className: "size-3" }), " Incoming flows"]
						})
					]
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(TrendingDown, { className: "size-3" }), " Outgoing flows"]
						})
					]
				})
			]
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Sparkles, { className: "size-5 text-signal" }), /* @__PURE__ */ jsx("h2", {
					className: "font-display text-xl font-bold",
					children: "Actionable Financial Signals"
				})]
			}), /* @__PURE__ */ jsx("div", {
				className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4",
				children: insights.map(({ title, desc, type, icon: Icon, metric }) => /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Icon, { className: `size-5 ${type === "warning" ? "text-warning-signal" : type === "positive" ? "text-signal" : "text-mute"}` }), /* @__PURE__ */ jsx("span", {
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsx(ResponsiveContainer, {
						...
						children: /* @__PURE__ */ jsxs(ComposedChart, {
							...
							children: [
								...
								forecast.hasEnoughData ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Bar, {
									dataKey: "actual",
									fill: "#f59e0b",
									radius: [
										4,
									...
									dot: { r: 3 },
									name: "Forecast"
								})] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Bar, {
									dataKey: "income",
									fill: "#10b981",
									radius: [
										4,
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: categoryData.length === 0 ? /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs(PieChart$1, { children: [/* @__PURE__ */ jsx(Pie, {
							...
							paddingAngle: 4,
							dataKey: "value",
							children: categoryData.map((_, index) => /* @__PURE__ */ jsx(Cell, { fill: COLORS[index % COLORS.length] }, `cell-${index}`))
						}), /* @__PURE__ */ jsx(Tooltip, { contentStyle: {
							backgroundColor: "#171717",
							borderColor: "#262626",
							borderRadius: "8px"
		...
		anomalies.length > 0 && /* @__PURE__ */ jsxs("div", {
			className: "mt-8 rounded-xl border border-warning-signal/30 bg-warning-signal/5 p-6",
			children: [
				/* @__PURE__ */ jsxs("div", {
					className: "mb-4 flex items-center gap-2",
					children: [/* @__PURE__ */ jsx(Radar, { className: "size-5 text-warning-signal" }), /* @__PURE__ */ jsx("h3", {
						className: "font-display font-bold",
				...
				/* @__PURE__ */ jsx("div", {
					className: "space-y-2",
					children: anomalies.slice(0, 6).map((a) => /* @__PURE__ */ jsxs("div", {
