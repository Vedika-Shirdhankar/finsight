import { t as supabase } from "./client-PdxCd9pa.js";
import { n as useAuth } from "./keys-C2024mUc.js";
import { n as useCreateAccount, t as useAccounts } from "./use-accounts-BXpHOKmP.js";
import { n as useInviteMember, t as useAccountMembers } from "./use-account-members-8yCSN_Z-.js";
import { n as useProfile, r as useUpdateProfile, t as getNotificationPreferences } from "./use-profile-BkKF9vVe.js";
import { useEffect, useState } from "react";
import { HeadContent, Link, Outlet, Scripts, createFileRoute, createRootRouteWithContext, createRouter, lazyRouteComponent, useRouter } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { QueryClient, QueryClientProvider, useQuery } from "@tanstack/react-query";
import { Bell, Building2, Coins, CreditCard, Landmark, Moon, Plus, Save, ShieldAlert, User, Wallet } from "lucide-react";
...
function RootComponent() {
	...
	return /* @__PURE__ */ jsxs(QueryClientProvider, {
		client: queryClient,
		children: [/* @__PURE__ */ jsx(AuthStateSync, {}), /* @__PURE__ */ jsx(Outlet, {})]
	});
}
...
var $$splitComponentImporter$10 = () => import("./routes-DLN54-li.js");
...
var $$splitComponentImporter$9 = () => import("./admin-Bys_y0Yy.js");
...
var $$splitComponentImporter$8 = () => import("./auth-Bhhpl3M7.js");
...
var $$splitComponentImporter$7 = () => import("./dashboard-ealJkjyI.js");
...
var $$splitComponentImporter$6 = () => import("./reset-password-Dgk9vgg5.js");
...
var $$splitComponentImporter$5 = () => import("./dashboard-Dyn6eDet.js");
var Route$7 = createFileRoute("/dashboard/")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
//#endregion
//#region src/components/dashboard/invite-member-dialog.tsx
		...
		children: /* @__PURE__ */ jsxs("form", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("label", {
					...
					children: ["Role", /* @__PURE__ */ jsxs("select", {
						value: role,
...
//#endregion
//#region src/hooks/queries/use-transaction-splits.ts
...
//#endregion
//#region src/components/dashboard/member-contribution-list.tsx
function MemberContributionList({ accountId, accountTotal }) {
	...
	if (!members?.length) return /* @__PURE__ */ jsx("div", {
		className: "mt-4 text-xs text-mute",
...
//#endregion
//#region src/routes/dashboard/accounts.tsx
...
function AccountsPage() {
	...
	const [inviteAccountId, setInviteAccountId] = useState(null);
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				...
				children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), " Add account"]
			})]
		}),
		/* @__PURE__ */ jsxs("div", {
			className: "mb-6 flex items-center gap-3 rounded-xl border border-line bg-panel p-4 text-xs text-mute",
			children: [/* @__PURE__ */ jsx(ShieldAlert, { className: "size-5 shrink-0 text-signal" }), /* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("strong", { children: "Simulated Workspace:" }), " Accounts listed below are simulated demo profiles for financial modeling. No real bank APIs or payment processors are linked."] })]
		}),
		/* @__PURE__ */ jsxs("div", {
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				!isLoading && accounts?.length === 0 && /* @__PURE__ */ jsx("div", {
					...
					return /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								}), acc.user_id === userId && /* @__PURE__ */ jsx("button", {
									onClick: () => setInviteAccountId(acc.id),
									className: "text-xs font-medium text-signal hover:underline",
									children: "Invite"
								})]
							}),
							/* @__PURE__ */ jsx(MemberContributionList, {
								accountId: acc.id,
		...
		inviteAccountId && /* @__PURE__ */ jsx(InviteMemberDialog, {
...
//#endregion
//#region src/routes/dashboard/budgets.tsx
var $$splitComponentImporter$4 = () => import("./budgets-BWWEDnSB.js");
var Route$5 = createFileRoute("/dashboard/budgets")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
//#endregion
//#region src/routes/dashboard/goals.tsx
var $$splitComponentImporter$3 = () => import("./goals-CeBfEGgh.js");
var Route$4 = createFileRoute("/dashboard/goals")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
//#endregion
//#region src/routes/dashboard/insights.tsx
var $$splitComponentImporter$2 = () => import("./insights-Dhf1bM1V.js");
var Route$3 = createFileRoute("/dashboard/insights")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
//#endregion
//#region src/routes/dashboard/recurring.tsx
var $$splitComponentImporter$1 = () => import("./recurring-BQdkesQF.js");
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(User, { className: "size-5 text-signal" }), /* @__PURE__ */ jsx("h2", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-3 mb-6 border-b border-line pb-4",
							children: [/* @__PURE__ */ jsx(Moon, { className: "size-5 text-signal" }), /* @__PURE__ */ jsx("h2", {
								className: "font-display text-lg font-bold",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-3 mb-6 border-b border-line pb-4",
							children: [/* @__PURE__ */ jsx(Bell, { className: "size-5 text-signal" }), /* @__PURE__ */ jsx("h2", {
								className: "font-display text-lg font-bold",
...
//#endregion
//#region src/routes/dashboard/transactions.tsx
var $$splitComponentImporter = () => import("./transactions-jG0QkCrc.js");
